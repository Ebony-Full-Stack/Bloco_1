...
public class exe01_versão2 {
	public static void main(String[] args) {
		...
		System.out.print("Vamos comeÃ§ar, digite sua data de nascimento dd/mm/aaaa: ");
		dtEntrada = ler.next();
		...
		try {
			...
			System.out.println("\nAtÃ© aqui, vocÃª viveu um total de " + diasVividos/86400000L + " dias.");
		}
		catch (ParseException e) {
			System.err.println("Ops, parece que vc inseriu uma data invÃ¡lida!");
		}
		ler.close();
	}
}
